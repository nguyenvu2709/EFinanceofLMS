...
import { listCourses } from "../../data/listCourse";
    ...
    <div className="container-board container-board-listCourses">
      <div className="board-listCourses-header">
        <ul className="board-listCourses-header-list">
          <li className="board-listCourses-header-item">
            ...
            <div className="board-listCourses-header-dropdown">
              <select className="board-listCourses-header-item-options">
                <option
                  className="board-listCourses-header-item-option"
                  value="Theo tín chỉ"
                >
                  Theo tín chỉ
                </option>
          ...
          <li className="board-listCourses-header-item">
            <span className="board-listCourses-header-item-name">Khoa</span>
            <div className="board-listCourses-header-dropdown">
              <select className="board-listCourses-header-item-options">
                <option
                  className="board-listCourses-header-item-option"
          ...
          <li className="board-listCourses-header-item">
            <span className="board-listCourses-header-item-name">Ngành</span>
            <div className="board-listCourses-header-dropdown">
              <select className="board-listCourses-header-item-options">
                <option
                  className="board-listCourses-header-item-option"
          ...
          {listCourses.map((course, index) => {
            return (
              <li key={index} className="board-listCourses-body-item">
                ...
                <Link
                  to="detail-course "
                  className="board-listCourses-body-item-information"
                >
                  <img
                    className="board-listCourses-body-item-icon"
                    src={iconInfo}
                  />
                </Link>
              </li>
